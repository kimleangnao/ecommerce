...
const ViewSingleProduct = ({
  ...
  const onChangeAddToCart = (productID) => {
    const productGender = product.productGender.filter(
      (gender) => gender.selected == true,
    );
    const productColor = product.productColors.filter(
      (prodColor) => prodColor.selected == true,
    );
    ...
    addToCart(
      productID,
      productColor[0].color,
      productGender[0].gender,
      productSize[0].size,
    );
  };

  const onChangeToWishList = (productID) => {
    const productGender = product.productGender.filter(
      (gender) => gender.selected == true,
    );
    const productColor = product.productColors.filter(
  ...
  return (
    <div
      className={
        switchStateBody
          ? "viewSingleProduct viewSingleProduct-hidden"
          : "viewSingleProduct"
      }
    >
      <NavbarExtend
      ...
      <ViewSingleProductDetails
        onChangeToWishList={onChangeToWishList}
