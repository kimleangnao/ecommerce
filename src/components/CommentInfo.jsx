const CommentInfo = ({ review }) => {
  let arrayRating = review.userRating
    ? Array(review.userRating).fill(null)
    : Array(0).fill(null);
  return (
    <div className="commentInfo">
      <div className="comment_image">
        <img
          ...
          alt="user-profile"
          className="comment_image_profile"
        />
      </div>
      <div className="comment_details">
        ...
        <div className="comment_details_review">{review.userComment}</div>
        <div className="comment_details_likeDislike">
          <button className="comment_details_likeDislike_replyBtn">
            REPLY
          </button>
